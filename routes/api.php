...
Route::prefix('users')->middleware(['auth:api'])->group(function () {
    ...
    Route::post('/create', [UserController::class, 'apiCreateUser'])->name('users.createUser');

    Route::put('/{id}', [UserController::class, 'apiUpdateUser'])->name('users.updateUser');

    Route::delete('/{id}', [UserController::class, 'apiDeleteUser'])->name('users.deleteUser');
...
// Route::middleware(['auth:api'])->group(function(){
//     Route::get('ticket/{id}', [TicketController::class,'ticket'])->name('myticket');
// });
...
Route::prefix('tickets')->middleware(['auth:api'])->group(function () {
    ...
    Route::post('/create', [TicketController::class, 'apiCreateTicket'])->name('tickets.createTicket');
